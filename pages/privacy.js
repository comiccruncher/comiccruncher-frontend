      ...
      <Flex flexWrap={'wrap'} m={'30px auto'} p={3}>
        <Box width={[1]}>
          ...
          <Text.Default>
            ...
            <p>
              Example ("us", "we", or "our") operates the https://comiccruncher.com website (hereinafter referred to as
              the "Service").
            </p>
            <p>
              This page informs you of our policies regarding the collection, use, and disclosure of personal data when
              you use our Service and the choices you have associated with that data. Our Privacy Policy for Comic
              Cruncher is based on the{' '}
              <a href="https://privacypolicies.com/blog/privacy-policy-template/">
                Privacy Policy Template from Privacy Policies
              </a>
              .
            </p>
            <p>
            ...
            <p>
              ...
              if you do not accept cookies, you may not be able to use some portions of our Service. You can learn more
              how to manage cookies in the{' '}
            ...
            <h2>Use of Data</h2>
            <p>Comic Cruncher uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              Comic Cruncher will take all steps reasonably necessary to ensure that your data is treated securely and
            ...
            <p>
              Comic Cruncher may disclose your Personal Data in the good faith belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of Comic Cruncher</li>
            ...
            <ul>
              <li>By email: aimee@aimeelaplant.com</li>
            </ul>{' '}
          </Text.Default>
        </Box>
      </Flex>
